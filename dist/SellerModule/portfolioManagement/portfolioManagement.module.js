...
const portfolioManagement_controller_1 = require("./portfolioManagement.controller");
...
PortfolioModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [portfolioManagement_service_1.PortfolioManagementService],
        controllers: [portfolioManagement_controller_1.PortfolioManagementController],
        exports: [],
    })
], PortfolioModule);
exports.PortfolioModule = PortfolioModule;
//# sourceMappingURL=portfolioManagement.module.js.map